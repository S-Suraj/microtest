...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "microtest@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "microtest API";

        private String description = "microtest API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "microtest";
